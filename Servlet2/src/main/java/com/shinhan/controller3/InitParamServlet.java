 ...
 * initParams = {
 * 
 * @WebInitParam(name = "myname", value = "hyun"),
 * 
 * @WebInitParam(name = "email", value = "1231@nqwe.do"),
 * 
...
public class InitParamServlet extends HttpServlet {
	...
	@Override
	public void destroy() {
		System.out.println("InitParamServlet소멸자");
	}
	...
	public void init() throws ServletException {
		System.out.println("InitParamServlet초기화");
	}
